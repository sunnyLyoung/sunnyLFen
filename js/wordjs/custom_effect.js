...
(function($) {
	"use strict";
		var isOn=1,sets, fx, toAnimate = "#effect", settings = {
			animation:14, //动画方式 从1-15 每个数字代表一个动画 请自测效果
		...
		function doThis(){
				fx = jQuery("#effect"+isOn);
				var animateObj='#effect'+isOn;			
				if(isOn === 13) { sets = {animation: 14, animationType: "in", restoreHTML: false,onComplete:false};}else{
					(isOn < 13) ? isOn++ : isOn = 0;	
					switch(isOn) {
						case 1:		
						//fx.html("灵活运用，制造自己的动画");				
						sets = {animation:14,animationType: "in",easing: "easeInQuint", restoreHTML: false};						
						break;
						
						case 2:
						//fx.html("灵活运用，制造自己的动画");
							sets = {animation: 14,animationType: "in", restoreHTML: false};
						break;
						...
						case 7:
							...
							sets = {animation: 14, backwards: true};
						break;
						
						case 8:
						//fx.html("灵活运用，制造自己的动画");
							sets = {animation: 14, animationType: "in", backwards: true, restoreHTML: false};
						break;
						
						case 9:
							//fx.html("有它，可以帮助你轻松完成简单动画");
							sets = {animation: 14, easing: "easeOutBounce"};
						break;
						
						case 10:
						//fx.html("灵活运用，制造自己的动画");
							sets = {animation: 14, animationType: "in", speed: 500, easing: "easeInBack", restoreHTML: false};
						break;
